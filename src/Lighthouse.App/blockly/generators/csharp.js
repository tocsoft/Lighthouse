...
Blockly.CSharp.DEBUGGER_CODE_ENTER = "";
Blockly.CSharp.DEBUGGER_CODE_EXIT = "";
/**
...
Blockly.CSharp.addReservedWords(
    ...
    // https://developer.mozilla.org/en/CSharp/Reference/Reserved_Words
    'break,case,catch,continue,debugger,default,delete,do,else,finally,for,function,if,in,instanceof,new,return,switch,this,throw,try,typeof,var,void,while,with,' +
    'class,enum,export,extends,import,super,implements,interface,let,package,private,protected,public,static,yield,' +
    'const,null,true,false,' +
    // https://developer.mozilla.org/en/CSharp/Reference/Global_Objects
...
Blockly.CSharp.ORDER_LOGICAL_NOT = 4;    // !
Blockly.CSharp.ORDER_BITWISE_NOT = 4;    // ~
Blockly.CSharp.ORDER_UNARY_PLUS = 4;     // +
Blockly.CSharp.ORDER_UNARY_NEGATION = 4; // -
Blockly.CSharp.ORDER_TYPEOF = 4;         // typeof
Blockly.CSharp.ORDER_VOID = 4;           // void
Blockly.CSharp.ORDER_DELETE = 4;         // delete
Blockly.CSharp.ORDER_MULTIPLICATION = 5; // *
Blockly.CSharp.ORDER_DIVISION = 5;       // /
Blockly.CSharp.ORDER_MODULUS = 5;        // %
Blockly.CSharp.ORDER_ADDITION = 6;       // +
Blockly.CSharp.ORDER_SUBTRACTION = 6;    // -
