...
Blockly.JavaScript.DEBUGGER_CODE_ENTER = Blockly.JavaScript.DEBUGGER_CODE_ENTER || "";
Blockly.JavaScript.DEBUGGER_CODE_EXIT = Blockly.JavaScript.DEBUGGER_CODE_EXIT || "";
...
Blockly.JavaScript.scrub_ = function(block, code) {
  ...
  if (block.outputConnection == null) {
      debugEnter = Blockly.JavaScript.DEBUGGER_CODE_ENTER.replace("%ID%", block.id);
      debugExit = Blockly.JavaScript.DEBUGGER_CODE_EXIT.replace("%ID%", block.id);
  }
